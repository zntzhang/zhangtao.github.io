...
[ http://www.cnblogs.com/qilong853/p/5982878.html](http://www.cnblogs.com/qilong853/p/5982878.html "用ThreadLocal类实现线程安全的正确姿势")

这边文章讲的很好,我就不复制黏贴了，
**ThreadLocal中保存的是Object对象的一个引用，这样的话，当有其他线程对这个引用指向的对象做修改时，当前线程Thread对象中保存的值也会发生变化**
...
坑在这里  
![图](http://img-blog.csdnimg.cn/20190627224218738.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM3MjIxOTkx,size_16,color_FFFFFF,t_70)  
