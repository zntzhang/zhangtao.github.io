...
![这里写图片描述](http://img-blog.csdn.net/20180531200737238?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM3MjIxOTkx/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
如果想要SERVICE抛出所有异常都能回滚，那么就要在 ` propagation="REQUIRED" ` 后面加上 ` rollback-for="Exception" `
